TRAIN_FLAGS="
    ...
    --batch_size 8 --microbatch 16 --lr 1e-4
    ...
    --tot_class 200
    --dataset_type imagenet-200   --imagenet200_class_list_file_path datasets/list_tiny_imagenet.txt
    --gpus 0,1,2,3
...
mpiexec -n 4 python classifier_train.py \
