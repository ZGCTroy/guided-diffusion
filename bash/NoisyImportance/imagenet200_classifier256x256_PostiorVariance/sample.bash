...
SAMPLE_FLAGS="
    ...
    --use_ddim True
    --log_root /mnt/data2/shengming/guided_ddpm/log
    --gpus 0,1,2,3
    "

mpiexec -n 4 python3 classifier_sample.py \
      ...
      --classifier_path /mnt/data2/shengming/guided_ddpm/log/imagenet200_classifier256x256_channel64_PostiorVarianceImportance/model070000.pt \
      --save_name imagenet200_classifier256x256_channel64_PostiorVarianceImportance/predict/model070000
