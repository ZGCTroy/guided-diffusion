...
mpiexec -n 2 --allow-run-as-root python classifier_sample.py \
      ...
      --classifier_path /workspace/guided-diffusion/log/imagenet200_classifier256x256_channel64_rangeUniform/model010000.pt \
      --save_name imagenet200_classifier256x256_channel64_rangeUniform/predict/model010000
