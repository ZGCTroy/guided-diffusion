...
save_name="imagenet1000_classifier128x128_channel128_entropyConstraintTrain0.2"
...
#    steps='ddim25'
#    scale=1.25
#    predict_name=find_optimal_entropy_scale/conditional_model${iteration}_steps${steps}_scale${scale}_sample${num_samples}_entropyScale
#
