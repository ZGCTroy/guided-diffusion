TRAIN_FLAGS="
    --iterations 310000 --batch_size 64 --microbatch 64
    --anneal_lr True --lr 6e-4 --weight_decay 0.2
    --save_interval 10000
...
save_name="imagenet1000_classifier64x64_channel128_entropyConstraintTrain0.05"
...
python -m torch.distributed.launch \
       ...
       classifier_train.py \
    $CLASSIFIER_FLAGS $TRAIN_FLAGS $DIFFUSION_FLAGS \
     --save_name $save_name \
     --uncertainty_lambda=0.05 --use_uncertainty_loss True