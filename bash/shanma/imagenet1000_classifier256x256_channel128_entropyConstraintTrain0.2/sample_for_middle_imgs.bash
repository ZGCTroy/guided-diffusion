...
#    steps='ddim25'
#    scale=10.0
#    predict_name=model${iteration}_steps${steps}_scale${scale}_sample${num_samples}_plot_for_middle_imgs
#
#    python -m torch.distributed.launch \
#       --nnode $WORLD_SIZE --node_rank $RANK --nproc_per_node 1 \
#       --master_addr $MASTER_ADDR --master_port $MASTER_PORT \
#       classifier_sample_for_middle_imgs.py \
#      $DIFFUSION_FLAGS $MODEL_FLAGS $CLASSIFIER_FLAGS $SAMPLE_FLAGS \
#      --log_root ${logdir} \
#      --save_name ${save_name}/predict/${predict_name} \
#      --classifier_scale ${scale} --num_samples ${num_samples} --batch_size 1 \
