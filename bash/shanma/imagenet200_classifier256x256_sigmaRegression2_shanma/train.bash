TRAIN_FLAGS="
    --iterations 700000 --anneal_lr True
    ...
    --variance_loss_type mse --variance_attr alphas_cumprod --classifier_variance_lambda 1.0
    "
...
mpiexec -n 2 --allow-run-as-root python classifier_train.py \
    $CLASSIFIER_FLAGS $TRAIN_FLAGS $SAMPLE_FLAGS $DIFFUSION_FLAGS $MODEL_FLAGS $EVALUATE_FLAGS \
     --save_name imagenet200_classifier256x256_channel64_sigmaRegression2
