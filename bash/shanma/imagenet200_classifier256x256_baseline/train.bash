TRAIN_FLAGS="
    ...
    --tot_class 200
    --dataset_type imagenet-200 --imagenet200_class_list_file_path /workspace/mnt/storage/guangcongzheng/zju_zgc/guided-diffusion/datasets/list_tiny_imagenet.txt
    --gpus 0,1
...
EVALUATE_FLAGS="
    --ref_batch /workspace/mnt/storage/guangcongzheng/zju_zgc/guided-diffusion/pretrain_model/VIRTUAL_tinyimagenet256_labeled.npz
    "
...
mpiexec -n 2 --allow-run-as-root python classifier_train.py \
    $CLASSIFIER_FLAGS $TRAIN_FLAGS $SAMPLE_FLAGS $DIFFUSION_FLAGS $MODEL_FLAGS $EVALUATE_FLAGS \
     --save_name imagenet200_classifier256x256_channel64_baseline_logEntropyLoss \
