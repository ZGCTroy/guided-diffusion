...
def main():
    ...
    if args.model_path:
        ...
        pretrained_model_dict = dist_util.load_state_dict(args.model_path, map_location="cpu")
    ...
    if args.classifier_path:
        ...
        pretrained_classifier_dict = dist_util.load_state_dict(args.classifier_path, map_location="cpu")
    ...
    for k, v in classifier.__dict__.items():
        logger.log(k, v)
